...
App::get('/v1/database/collections/:collectionId/documents')
    ...
    ->action(function ($collectionId, $queries, $limit, $offset, $orderAttributes, $orderTypes, $response, $dbForExternal) {
        ...
        if ($collection->getAttribute('enforce') === 'collection') {
            ...
            $documents = Authorization::skip(function() use ($dbForExternal, $collectionId, $queries, $limit, $offset, $orderAttributes, $orderTypes) {
                return $dbForExternal->find($collectionId, $queries, $limit, $offset, $orderAttributes, $orderTypes);
            });
        } else {
